...
class ConsumableOrderModel extends MasterModel
{

// fetch table data
	public function getSelectConsumableGroupData($tableName)
	{
...
public function placeConsumableMaterialListOrder($tableName, $formData)
	{
		try {
			$this->db->trans_start();
