...
//            echo"HR";
    ...
    public function get_all_designations($firm_id) { //function to get all designation
...
//        print_r($this->db->last_query());
    ...
    public function user_is_ca($user_id) { //done by pooja
    ...
    public function get_all_template($firm_id) { //function to get all template.....done by pooja lote
