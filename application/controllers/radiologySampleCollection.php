					...
					<div class="card">
						<div class="card-header-action">
							<ul class="nav nav-pills" id="serviceOrderTablist" role="tablist">
								<li class="nav-item">
									<a class="nav-link active" id="standardLabTab" data-toggle="tab" href="#standardLab1" role="tab"
								...
								<li class="nav-item">
									<a class="nav-link" id="serviceOrderTab" data-toggle="tab" href="#serviceOrder1"
									   role="tab" aria-controls="serviceOrder1" aria-selected="false">Service Order Request</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" id="orderPlaceTab" data-toggle="tab" href="#placeOrder1" role="tab"
							...
							<div class="tab-pane fade show active" role="tabpanel" id="standardLab1">
								<form id="uploadStandardLabServices" method="post" onsubmit="return false">
									...
									<table class="table-bordered" align="center">
										...
										<th>Day</th>
										<th>
											<select class="form-control" name="labDay" id="labDat" onchange="getStandardLabServices(this.value)">
												<option value="1">1st day of patient</option>
												...
												<option value="0">select any other date</option>
											</select>
											<div id="standardLabDateDiv" class="mt-1 d-none">
												<input type="datetime-local" name="standardLabDate" id="standardLabDate">
											</div>
										</th>
										</thead>
											...
											<div class="card my-0 shadow-none">
												<div class="card-body">
													...
													<div class="" id="serviceCategoryshow">
														<div class="form-row">
															<div class="form-group my-0 py-0 col-md-6">
																...
																<select id="bservice_cat" name="bservice_cat" class="form-control" onchange="getServiceName(this.value)">
																	<option value="" selected disabled>Select Service Category</option>
																	<option value="RADIOLOGY">Radiology</option>
																	<option value="PATHOLOGY">Pathology</option>
																	<option value="PROCEDURE">Procedure</option>
																	<option value="EQUIPMENT">Bio Medical Equipment</option>
															...
															<div class="form-group my-0 py-0 col-md-6">
																...
																<select id="bserviceOrder_name" name="bserviceOrder_name" class="form-control" onchange="getServiceDescription(this.value)">
														...
														<div class="form-row">
															<div class="form-group my-0 py-0 col-md-3">
																...
																<select id="bserviceOrder_desc" name="bserviceOrder_desc" class="form-control" onchange="getServiceRate(this.value)">
																	<option value="">No data found</option>
																</select>
															</div>
															<div class="form-group my-0 py-0 col-md-2">
															...
															<div class="form-group my-0 py-0 col-md-2">
																<label>Unit</label>
																<input type="number" name="serviceOrder_unit" id="serviceOrder_unit" value="1" class="form-control">

															</div>
															<div class="form-group my-0 py-0 col-md-3">
																<label>Service Date</label>
																<input type="datetime-local" name="serviceOrder_date" id="serviceOrder_date" class="form-control">

															</div>
															<div class="modal-footer my-0 py-0 col-md-2">

																<button class="btn btn-default mr-1 mt-4" type="button" onclick="addServiceOrderItem()" style="background: #891635;color: white">Add to list</button>
													...
													<div class="form-row">
														...
														<div class="modal-footer my-0 py-0 col-md-4" style="margin-left: auto;">

															<button class="btn btn-default mr-1" type="button" onclick="place_serviceOrder()" style="background: #891635;color: white">Place Order</button>
															<button class="btn btn-secondary" type="reset">Reset</button>
															<div id="clearListButtonDiv" class="mr-1 d-none" style="margin-left: auto;">
																<button type="button" class="btn btn-primary" onclick="clearListServiceItem()" style="float: right;">Clear List</button>
															</div>
														</div>
							...
							<div class="tab-pane fade" role="tabpanel" id="placeOrder1">
								<div class="card-body view">
									<div class="table-responsive wrapper">
										<table class="table-striped table-bordered" id="orderPlaceTable" style="width: 100%">
											<!-- <thead>
											<tr>
												<td>service</td>
												<td>date</td>
