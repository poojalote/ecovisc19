...
<div class="main-sidebar text-center sidebar-style-2" tabindex="1"
	...
	<aside id="sidebar-wrapper" style="">
		...
		<ul class="sidebar-menu">
			<a href="<?php echo base_url(); ?>patient_info" class="" style="text-decoration: none;"><li class="menu-header menu-header_section1" style=" ">Dashboard</li></a>
...
<div class="main-sidebar1 mobile_menu_hide">
	...
	<div class="buttons">
		<a href="<?php echo base_url(); ?>patient_info" data-toggle="tooltip" data-placement="top" title="Dashboard" class="btn btn-icon btn-light"><i class="fas fa-tachometer-alt"></i></a>
		<?php if ( in_array("userlist", $permission_array)) { ?>
		<a href="<?php echo base_url(); ?>company/view_user" data-toggle="tooltip" data-placement="top" title="User List"
					...
					if ($dep !== 0) {
						...
						if (!empty($departments) && count($departments) > 0) {
							foreach ($depArray as $depItems) {
								...
								?>
								<a href="<?php echo base_url(); ?>company/form_view/<?php echo $dep_encode ?>" data-toggle="tooltip" data-placement="top" title="<?php echo $depItems->departmentName; ?>"
		...
		<a href="<?php echo base_url(); ?>company/admin/medicine_master" data-toggle="tooltip" data-placement="top" title="Medicine Master"
		...
		<a href="<?php echo base_url(); ?>company/admin/prescription_master" data-toggle="tooltip" data-placement="top" title="Prescription Master"
		   class="btn btn-icon <?php echo $this->uri->segment(3) == 'prescription_master' ? 'btn-primary' : 'btn-light'; ?>"><i
					class="fas fa-prescription"></i></a>
		<?php } ?>
		<a href="<?php echo base_url(); ?>company/admin/hospital_order_management" data-toggle="tooltip" data-placement="top" title="Hospital Order Management"
