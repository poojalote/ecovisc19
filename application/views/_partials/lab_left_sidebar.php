...
<div class="main-sidebar text-center sidebar-style-2" tabindex="1"
    ...
    <aside id="sidebar-wrapper" style="">
        ...
        <ul class="sidebar-menu" id="sidebar-menu1">
            <a href="<?php echo base_url(); ?>labpatient_info" class="list_ang"
               style="<?php echo $this->uri->segment(1) == 'patient_info' ? 'color: white;text-decoration: none;' : 'color: black;text-decoration: none;'; ?>">
                <li class="menu-header mt-2 <?php echo $this->uri->segment(1) == 'labpatient_info' ? 'menu-header_section active' : 'menu-header_section1'; ?>">
                    Patient List
                </li>
            </a>
            ...
            if (in_array("patient_registration", $permission_array)) { ?>
                <a href="<?php echo base_url(); ?>lab_patient"
                   style="<?php echo $this->uri->segment(2) == 'new_patient' || $this->uri->segment(1) == 'new_patients' ? 'color: white;text-decoration: none;' : 'color: black;text-decoration: none;'; ?>">
                    <li class="menu-header mt-2 <?php echo $this->uri->segment(2) == 'lab_patient' || $this->uri->segment(1) == 'lab_patient' ? 'menu-header_section active' : 'menu-header_section1'; ?>"
                        style="">
            ...
            ?>" class="" style="text-decoration: none;">
                <li class="menu-header mt-2 menu-header_section1">Setup Lab Test/ Packages</li>
            </a>
            <!--  <a href="<?php
            $qparam = base64_encode(json_encode(array("branch_id"=>$this->session->user_session->branch_id)));
            echo base_url("setup_child_lab_master/22/139/".$qparam);
            ?>" class="" style="text-decoration: none;">
                <li class="menu-header mt-2 menu-header_section1">Setup Child Lab Test</li>
            </a>
            <a href="<?php
            $qparam = base64_encode(json_encode(array("branch_id"=>$this->session->user_session->branch_id)));
            echo base_url("master_package/22/140/".$qparam);
            ?>" class="" style="text-decoration: none;">
    ...
    <aside id="sidebar-wrapper2"  style="display: none">
        <div class="profile-widget-header mt-5">
            <div class="rounded-circle profile-widget-picture">
                <i class="fas fa-user-md" style="font-size: 6rem"></i>
            </div>
        ...
        <div class="mt-2">
            <b style="text-transform: uppercase;" id="patient_name"></b>
        </div>
        <div>
            <small id="adhar_number"></small>
        </div>
        <div class="sidebar-brand sidebar-gone-show"><a href="index.html"></a></div>
        <ul class="sidebar-menu" id="sidebar-menu2">
            <a href="<?php echo base_url(); ?>labpatient_info" class="list_ang"
               style="<?php echo $this->uri->segment(1) == 'patient_info' ? 'color: white;text-decoration: none;' : 'color: black;text-decoration: none;'; ?>">
                <li class="menu-header mt-2 <?php echo $this->uri->segment(1) == 'labpatient_info' ? 'menu-header_section active' : 'menu-header_section1'; ?>">
                    Home
            ...
            <a id="tabDepartment0" href="#departmentPanel0" class="list_ang a_menu a_menu_1"
               style="color: white;text-decoration: none;">
                <li class="menu-header mt-2 li_menu menu-header_section active li_menu_1">
                    Lab Service Order
                </li>
            </a>
            <a id="tabMasterTest0" href="#masterTestPanel0" class="list_ang a_menu a_menu_143"
               style="color: black;text-decoration: none;">
                <li class="menu-header mt-2 li_menu menu-header_section1 li_menu_143">
                    Lab Data Entry
                </li>
            </a>
            <a id="tabChildTest0" href="#childTestPanel0" class="list_ang a_menu a_menu_2"
               style="color: black;text-decoration: none;">
                <li class="menu-header mt-2 li_menu menu-header_section1 li_menu_2">
                    Report
                </li>
            </a>
            <a id="tabUnitMaster0" href="#unitMasterPanel0" class="list_ang a_menu a_menu_144"
               style="color: black;text-decoration: none;">
                <li class="menu-header mt-2 li_menu menu-header_section1 li_menu_144">
                    Payment
                </li>
            </a>
        </ul>
...
<div class="main-sidebar1 mobile_menu_hide">
    ...
    <div class="buttons">
        ...
        <?php } ?>
        <a href="<?php echo base_url(); ?>bedManagement"  data-toggle="tooltip" data-placement="top" title="Bed Management"
...
<script type="text/javascript">
    function get_lableftsidebar()
    {
        if(localStorage.getItem("leftsidebar")!=null)
        {
            if(localStorage.getItem("leftsidebar")==2)
            {
                document.getElementById('sidebar-wrapper').style.display='none';
                document.getElementById('sidebar-wrapper2').style.display='block';
                document.getElementById('patient_name').innerHTML=localStorage.getItem("patient_name");
                document.getElementById('adhar_number').innerHTML=localStorage.getItem("patient_adharnumber");
            }
            else
            {

                document.getElementById('sidebar-wrapper2').style.display='none';
