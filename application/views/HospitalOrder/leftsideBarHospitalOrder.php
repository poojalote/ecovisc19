												...
												<div id="" class="p-3">
													...
													<div class="form-row">
														...
														<div class="form-group col-md-6">
															...
															<input type="text" class="form-control" readonly name="ret_order_invoice_no"
																   id="ret_order_invoice_no"  
																   aria-required="true">
														</div>
														<div class="form-group col-md-6">
									...
									<form id="receiveOrderForm" name="receiveOrderForm" method="post" onsubmit="return false">
												<div id="" class="p-3">
													...
													<div class="form-row">
														...
														<div class="form-group col-md-6">
															<label>Invoice No.</label>
															<input type="text" class="form-control" name="hos_order_invoice_no"
																   id="hos_order_invoice_no" placeholder="Enter Invoice No."
																   aria-required="true">
														</div>
														<div class="form-group col-md-6">
															<label>Vendor Name</label>
														...
														<div class="form-group col-md-6">
															<!-- <label>Invoice Amount</label> -->
															<input type="hidden" class="form-control" name="hos_invoice_amount"
