					...
					<div class="card my-0 shadow-none">
						<div class="card-body">
							<ul class="nav nav-tabs" id="usertab" role="tablist">
									...
									<div class="tab-content">
										<div class="tab-pane fade show active"
											...
											<?php
							if($role == 2){ ?>
								<input type="hidden" id="uAllCompanies" name="uAllCompanies" value="<?php echo $company_id ?>">
								<input type="hidden" id="uAllBranches" name="uAllBranches" value="<?php echo $branch_id ?>">
								<input type="hidden" id="role" name="role" value="<?php echo $role ?>">
							<?php }else{ ?>
								<div class="form-group  py-0">
								<label>Select Company</label>
								<select class="form-control select2" id="uAllCompanies" name="uAllCompanies" onchange="getCompanyBranches(this.value)"
										data-valid="required"
							...
							<div class="form-group  py-0">
								...
								<input type="text" class="form-control" name="user_name" id="user_name" data-valid="required"
									   data-msg="Enter name">
							</div>
							<div class="form-group  py-0">
								<label>User Name</label>
								<input type="text" class="form-control" name="user_email" id="user_email" data-valid="required"
									   data-msg="Enter username">
							</div>
							<div class="form-group  py-0">
								<label>Password</label>
								<input type="password" class="form-control" name="password" id="password" data-valid="required"
							...
							<div class="tab-pane fade"
								...
								<?php
							if($role == 2){ ?>
								<input type="hidden" id="uAllCompanies1" name="uAllCompanies1" value="<?php echo $company_id ?>">
								<input type="hidden" id="uAllBranches1" name="uAllBranches1" value="<?php echo $branch_id ?>">
								
							<?php }else{ ?>
								<div class="form-group  py-0">
								<label>Select Company</label>
								<select class="form-control select2" id="uAllCompanies1" name="uAllCompanies1" onchange="getCompanyBranches(this.value)"
										data-valid="required"
										data-msg="Select Company name">
							...
							<div class="form-group  py-0">
								...
								<input type="text" class="form-control" name="user_name1" id="user_name1" data-valid="required"
									   data-msg="Enter name">
							</div>
							<div class="form-group  py-0">
								<label>User Name</label>
								<input type="text" class="form-control" name="user_email1" id="user_email1" data-valid="required"
									   data-msg="Enter username">
							</div>
							<div class="form-group  py-0">
								<label>Password</label>
								<input type="password" class="form-control" name="password1" id="password1" data-valid="required"
									   data-msg="Enter Password">
							</div>
							<button class="btn btn-primary mr-1" type="submit">Submit</button>
