				...
				<div class="modal-body py-0">
					<div class="card my-0 shadow-none">
						<div class="card-body">
							...
							<div class="form-group my-2 py-0">
								<label class="custom-switch">
									<input type="radio" name="ch_admin_template" id="ch_admin_template"  class="custom-switch-input" onclick="checkTemplateType('ch_free_template')">
									<span class="custom-switch-indicator"></span>
									<span class="custom-switch-description">is admin template</span>
								</label>
								<label class="custom-switch">
									<input type="radio" name="ch_free_template" id="ch_free_template"  class="custom-switch-input" onclick="checkTemplateType('ch_admin_template')">
									<span class="custom-switch-indicator"></span>
									<span class="custom-switch-description">is free form template</span>
								</label>
							</div>
