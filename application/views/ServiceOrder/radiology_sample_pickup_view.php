				...
				<div class="">
					...
					<div class="card">
						<div class="card-header">
							...
							<div class="card-header-action col-md-4">

								<div class="form-group mx-2 my-0">
									<select class="form-control" id='sampleAllPatient'
											onchange="getSampleCollectionTable1('RADIOLOGY','radiologySampleTable',this.value)" style="width: 100%">
									</select>
								</div>
			...
			<form id="radioFileUploadationForm" method="post" onsubmit="return false">
				<div class="row">
					<div class="col-md-12">
							...
							<div class="form-row">
								<div class="form-group col-md-12">
									<label for="normal_status">Status</label>
