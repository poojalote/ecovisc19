<div class="smiley-panel">
	...
	<ul class="nav customtab2 nav-tabs menu-tabs" role="tablist" style="padding: 0;">
		<li role="presentation" class="menu-item active"><a href="#people" aria-controls="people" role="tab"
															data-toggle="tab" aria-expanded="true"><i
						class="ti-face-smile"></i></a></li>
		<li role="presentation" class="menu-item"><a href="#nature" aria-controls="nature" role="tab" data-toggle="tab"
													 aria-expanded="false"><i class="ti-gallery"></i></a></li>
		<li role="presentation" class="menu-item"><a href="#food" aria-controls="food" role="tab" data-toggle="tab"
													 aria-expanded="false"><i class="fa fa-cutlery"></i></a></li>
		<li role="presentation" class="menu-item"><a href="#activity" aria-controls="activity" role="tab"
													 data-toggle="tab" aria-expanded="false"><i
						class="ti-basketball"></i></a></li>
		<li role="presentation" class="menu-item"><a href="#travel" aria-controls="travel" role="tab" data-toggle="tab"
		...
		<li role="presentation" class="menu-item"><a href="#symbols" aria-controls="symbols" role="tab"
													 data-toggle="tab" aria-expanded="false"><i
						class="ti-heart"></i></a></li>
		<li role="presentation" class="menu-item"><a href="#flags" aria-controls="flags" role="tab" data-toggle="tab"
													 aria-expanded="false"><i class="ti-flag-alt"></i></a></li>
	</ul>
	<!-- Tab panes -->
